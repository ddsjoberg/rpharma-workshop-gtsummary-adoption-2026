...
1. Open the script `exercises/exercises.R` in RStudio and find [Exercise 3]{.emphasis}.
...
1. Open the script `exercises/exercises.R` in RStudio and find [Exercise 4]{.emphasis}.
