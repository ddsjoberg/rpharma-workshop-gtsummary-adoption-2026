...
::: {.column width="60%"}
<img src="../images/gtsummary-logo.png" alt="gtsummary logo" width="55%"/>
:::
...
<div class="instructor-cards">
  <figure>
    <img src="../images/dan-circle.png" alt="Headshot of Daniel Sjoberg">
    <figcaption>
  ...
  <figure>
    <img src="../images/shannon-pileggi-circle.png" alt="Headshot of Shannon Pileggi">
    <figcaption>
      <span class="name">Shannon Pileggi</span>
      <span class="role">Associate Director of Data Science, The Prostate Cancer Clinical Trials Consortium</span>
    </figcaption>
  </figure>
</div>
```
