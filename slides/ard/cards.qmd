...
-   Collaboration among Roche, GSK, Novartis, Eli Lilly, Pfizer, Clymb, Kardigan
...
1. Open [Exercise 1](https://ddsjoberg.github.io/rpharma-workshop-gtsummary-adoption-2026/exercises/exercises.html#exercise-1) on the workshop site and copy it into Positron/RStudio.
...
#| cache: false
library(countdown)
countdown(minutes = 7, play_sound = TRUE)
```
